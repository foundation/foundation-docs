...
handlebars.registerHelper('heading', function(level, anchor, options) {
  ...
  return format('<h{0} id="{1}" class="docs-heading"{3}>{2}<a class="docs-heading-icon" href="#{1}"></a></h{0}>', [level, escapedText, options.fn(this), magellan]);
});
...
handlebars.registerHelper('jsOptionName', function(name) {
  return 'data-' + kebab(name);
});

handlebars.registerHelper('jsOptionValue', function(name) {
...
handlebars.registerHelper('jsEventName', function(name, title) {
