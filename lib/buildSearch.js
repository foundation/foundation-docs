...
var OUTPUT_FOLDER = path.join(process.cwd(), '_build/data');
var OUTPUT_PATH = path.join(OUTPUT_FOLDER, 'search.json');
...
module.exports = function buildSearch(data, cb) {
  var tree = [];
  ...
  fs.writeFile(OUTPUT_PATH, JSON.stringify(tree, null, '  '), cb);
}
