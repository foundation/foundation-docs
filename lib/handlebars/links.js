...
handlebars.registerHelper('editLink', function(repo, branch, value) {
  ...
  return format('https://github.com/foundation/{0}/edit/{1}/{2}', [repo, branch, value]);
});
...
handlebars.registerHelper('issueLink', function(repo, name) {
  return 'https://github.com/foundation/'+repo+'/issues/new?' + querystring.stringify({
...
//       'https://github.com/foundation/'+repo+'/tree/master/' + module,
