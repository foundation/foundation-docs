 ...
 */
handlebars.registerHelper('formatJsOptionValue', function(name, options) {
  // Return an empty string if the option has no value, or if `name` is the Handlebars context
  if (typeof name === 'undefined' || typeof options === 'undefined') return '';
